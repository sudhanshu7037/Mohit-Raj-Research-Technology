...
const ProductsDropdown = ({ handleMouseEnter, handleMouseLeave, activeMenu }) => {
  return (
    ...
    >
      ...
      {activeMenu === "products" && (
        <div className="fixed top-[104px] left-0 w-screen z-50">
          {/* Whole background creative section */}
          <div className="bg-gradient-to-br from-purple-100 via-yellow-50 to-blue-100 px-10 py-12 shadow-2xl backdrop-blur-md transition-all duration-300">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
              {[
                ...
                <div
                  key={index}
                  className=" rounded-2xl p-6 shadow-xl hover:shadow-yellow-400 border border-gray-200 hover:border-yellow-300 transition duration-300 transform hover:-translate-y-1"
                >
                  {/* Heading Box: Ubhra hua colorful box */}
