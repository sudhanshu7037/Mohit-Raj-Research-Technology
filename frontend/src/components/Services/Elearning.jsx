...
const elearningservices = [
  {
    ...
    description:
      "Live interactive teaching environments with video conferencing, whiteboards, and real-time Q&A.",
  },
  {
    title: "Learning Management Systems (LMS)",
    icon: <FaLaptopCode className="text-pink-500 text-3xl" />,
    description:
      "Custom LMS solutions for managing, tracking, and delivering educational content seamlessly.",
  },
  {
    title: "eContent Development",
    icon: <FaBookOpen className="text-pink-500 text-3xl" />,
    description:
      "Engaging digital learning materials like videos, quizzes, and interactive modules.",
  },
  {
    title: "Mobile Learning Apps",
    icon: <FaMobileAlt className="text-pink-500 text-3xl" />,
    description:
      "Responsive mobile apps for learning on the go, accessible across devices.",
  },
  {
    title: "Video-Based Learning",
    icon: <FaVideo className="text-pink-500 text-3xl" />,
    description:
      "Dynamic and visually rich video content for enhanced learner engagement.",
  },
  {
    title: "Cloud-Based eLearning",
    icon: <FaCloud className="text-pink-500 text-3xl" />,
    description:
      "Scalable and secure cloud solutions for seamless access to learning platforms.",
  },
];
...
const elearningServices = [
  {
    ...
    description:
      "Designing visually rich educational videos with animation and narration for effective learning.",
  },
  {
    icon: <FaVideo className="text-3xl text-blue-600" />,
    title: "2D & 3D Animation",
    description:
      "Creating immersive animated content to explain complex e-learning topics visually.",
  },
  {
    icon: <FaChalkboard className="text-3xl text-blue-600" />,
    title: "Virtual Classrooms",
    description:
      "Enabling real-time teaching sessions with whiteboard, chat, and multimedia support.",
  },
  {
    icon: <FaLaptop className="text-3xl text-blue-600" />,
    title: "E-Learning Content Editing",
    description:
      "Professional editing of audio, video, and visuals to enhance content quality.",
  },
  {
    icon: <FaBookOpen className="text-3xl text-blue-600" />,
    title: "Gamified Assessments",
    description:
      "Building game-based quizzes and modules to improve learner engagement.",
  },
  {
    icon: <FaMobileAlt className="text-3xl text-blue-600" />,
    title: "Mobile-First Media",
    description:
      "Optimizing multimedia content for mobile devices for on-the-go learning.",
  },
];
const elearningSteps = [
  {
    ...
    description:
      "We understand your learning goals and define the content structure accordingly.",
  },
  {
    icon: <FaUsers className="text-blue-600 text-2xl" />,
    title: "Content Design",
    description:
      "Our team creates interactive, multimedia-rich modules tailored to your audience.",
  },
  {
    icon: <FaLaptopCode className="text-blue-600 text-2xl" />,
    title: "Platform Integration",
    description:
      "We integrate your content into LMS platforms for easy distribution and management.",
  },
  {
    icon: <FaCheckCircle className="text-blue-600 text-2xl" />,
    title: "Testing & Launch",
    description:
      "Before deployment, we ensure your content is polished, responsive, and accessible.",
  },
];
    ...
    <>
      ...
      <section className="relative bg-black text-white font-sans min-h-screen flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start text-left px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            <button className=" border b hover:bg-white hover:text-black px-4 py-2 sm:px-6 sm:py-3 rounded-md text-sm sm:text-base md:text-lg font-medium transition">
              GET IN TOUCH
            </button>
      ...
      <div className="bg-white py-16 px-4 lg:px-24 text-center">
        ...
        <p className="text-gray-700 text-base md:text-lg max-w-4xl mx-auto mb-12 leading-relaxed font-basis text-justify mt-4">
          MOHITRAJ RESEARCH AND TECHNOLOGY PRIVATE LIMITED is a pioneering
          provider of comprehensive <strong>e-learning solutions</strong> in
          India. We specialize in developing robust Learning Management Systems
          (LMS), virtual classroom platforms, and custom educational software
          that transform how institutions deliver learning. Our EdTech
          innovations support schools, colleges, and professional training
          providers with tools for course management, student assessment,
          content delivery, and seamless communication.
          <br />
          <br />
          With over two decades of expertise, our dedicated team merges
          technology and education to create scalable, engaging, and interactive
          digital learning environments. Whether you're looking to implement
          blended learning, manage digital classrooms, or provide skill-based
          training at scale, our solutions are crafted to drive measurable
          learning outcomes and educational excellence.
        </p>
      </div>
      {/*new section third*/}
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
          At MRT, we empower educational institutions and enterprises with
          robust e-learning technologies tailored for engagement, accessibility,
          and performance.
        </p>
      ...
      {/* Contact Section */}
      <div
        className="group relative bg-gradient-to-tr from-white via-blue-50 to-orange-100 py-14 px-6 sm:px-10 md:px-20 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 
      hover:from-blue-100 hover:to-orange-200 hover:bg-opacity-80 hover:cursor-pointer"
      >
        {/* Glassy Box */}
        <div
          className="backdrop-blur-xl bg-white/70 border border-white/30 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row justify-between items-center gap-8 
        ...
        >
          ...
          <div className="max-w-2xl text-center md:text-left">
            ...
            <p className="mt-4 text-gray-700 group-hover:text-blue-800 text-base sm:text-lg transition duration-300">
              Empower learners and educators through interactive platforms,
              mobile learning, and tailored content strategies designed to drive
      ...
      >
        <div className="text-center text-blue-900 mb-8">
          ...
          <p className="max-w-2xl mx-auto text-lg font-basis">
            MRT has successfully deployed scalable and secure e-learning systems
            for educational institutions, corporate clients, and online
            academies. Here are the key industries we serve:
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto bg-white rounded shadow-lg overflow-hidden">
          ...
          <div className="p-8 text-gray-800">
            <p className="mb-6">
              Our e-learning solutions cater to a broad range of domains
              ensuring learner engagement, performance tracking, and seamless
              content delivery.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-600 max-w-4xl mx-auto mb-12">
          We provide end-to-end e-learning content development services that
          combine technology and creativity to boost learning outcomes.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <h2 className="text-4xl font-bold text-blue-900 text-center mb-4 font-houschka">
          Start Your <span className="text-pink-600">E-Learning</span> Project
          with MRT
        </h2>
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
          MRT provides complete e-learning development solutions using
          interactive content, animations, and intuitive LMS integration.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
          MRT is your trusted partner in delivering high-impact e-learning
          solutions. From interactive modules to mobile-ready content, we help
          educators and businesses transform learning experiences.
        </p>
          ...
          {[
            {
              ...
              description:
                "We create learner-centric modules tailored to your training goals.",
            },
            {
              icon: <FaLaptopCode className="text-3xl text-pink-500" />,
              title: "Custom LMS Integration",
              description:
                "Seamless LMS development and integration for smooth learner tracking.",
            },
            {
              icon: <FaBookOpen className="text-3xl text-pink-500" />,
              title: "Content Interactivity",
              description:
                "Engage users with quizzes, animations, and real-time assessments.",
            },
            {
              icon: <FaMobileAlt className="text-3xl text-pink-500" />,
              title: "Mobile-Optimized Learning",
              description:
                "Deliver smooth learning experiences across all screen sizes and devices.",
            },
          ].map((feature, index) => (
            <div
              key={index}
